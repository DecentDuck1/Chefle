...
- `CNAME`: custom-domain marker for `chefle.org`.
...
This bundle is built for `chefle.org` through `.github/workflows/deploy-pages.yml`. In GitHub repository settings, set Pages to use GitHub Actions, then set the custom domain to `chefle.org`.
